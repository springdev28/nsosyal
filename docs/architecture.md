...
12 MB sınırını, MP4/WebM için 50 MB ve kapsayıcıdan okunan 90 saniye sınırını,
ayrıca zorunlu medya açıklamasını sunucuda uygular. Süresi okunamayan veya MIME
ile kapsayıcısı uyuşmayan video yazılmadan reddedilir. Demo modunda dosyalar
`public/uploads` altına yazılır ve kayıt `DemoStore` üzerinden oluşturulur.
